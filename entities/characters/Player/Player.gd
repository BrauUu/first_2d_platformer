...
const DUST_EFFECT_ON_JUMP := preload("res://entities/effects/dust_effect_on_jump/DustEffectOnJump.tscn")
const PLAYER_ATTACK := preload("res://entities/actions/player_attack/PlayerAttack.tscn")
